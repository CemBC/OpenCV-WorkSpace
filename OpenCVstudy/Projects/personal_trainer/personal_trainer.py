...
def findAngle(img , p1 , p2 , p3 , lmList , draw = True):
    ...
    if draw:
        ...
        cv2.putText(img, str(int(angle)), (x2-40 , y2 +40), cv2.FONT_HERSHEY_PLAIN, 2, (0,255,255))
    return angle
...
while True:
    ...
    if len(lmList) != 0:
        ...
        cv2.putText(img, str(int(count)), (45,125), cv2.FONT_HERSHEY_PLAIN, 6, (255,0,0) , thickness = 5 )
